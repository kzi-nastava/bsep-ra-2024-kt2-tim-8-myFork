...
function CreateCertificate() {
  ...
  const [uniqueEmailForNewSubject, setUniqueEmailForNewSubject] =
    useState(false);
  ...
  const [subjectKeyIdentifierChecked, setSubjectKeyIdentifierChecked] =
    useState(false);
        ...
        {activeStep === 0 && (
          <div className="wrapper">
            ...
            <RadioGroup
              ...
              onChange={handleTypeOfCertificateChange}
            >
              <FormControlLabel
                value="selfsigned"
                control={<Radio />}
                  ...
                  <div className="scrollCertificates">
                    {certificates.map((item) => (
                      <div
                        ...
                        style={{
                          backgroundColor: isSelectedCertificate(item)
                            ? "var(--outlines)"
                            : "inherit",
                        }}
                      >
                    ...
                    {existingAccounts != null && (
                      <div className="scrollAccounts">
                        {existingAccounts.map((item) => (
                          <div
                            className="accountsWrapper"
                            onClick={() => {
                              handleSelectedAccount(item.email);
                            }}
                            style={{
                              backgroundColor: isSelectedAccount(item.email)
                                ? "var(--outlines)"
                                : "inherit",
                            }}
                          >
        ...
        {activeStep === 3 && (
          <div className="wrapper">
            {typeOfCertificate === "selfsigned" && (
              <>
                <h2>
                  Select date from when the certificate is valid that is not in
                  the past
                </h2>
            ...
            {typeOfCertificate === "caissued" && (
              <>
                <h2>
                  Select date from when the current certificate is valid and it
                  must be in between valid dates of issuing certificate
                </h2>
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                  <DatePicker
                    label="End date"
        ...
        {activeStep === 4 && (
          <div className="wrapper">
            {typeOfCertificate === "selfsigned" && (
              <>
                <h2>
                  Select date until the certificate is valid and that date must
                  be after certificate start date
                </h2>
            ...
            {typeOfCertificate === "caissued" && (
              <>
                <h2>
                  Select date until when the certificate is valid and that date
                  must be in between current certificate start date and issuing
          ...
          <div className="wrapper">
            ...
            <FormGroup>
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={subjectKeyIdentifierChecked}
          ...
          {activeStep !== steps.length - 1 ? (
            <Button
              ...
              disabled={
                ...
                (activeStep === 1 &&
                  typeOfCertificate === "caissued" &&
                  selectedCertificate.issuerSerialNumber == null) ||
                (activeStep === 1 &&
                  typeOfCertificate === "selfsigned" &&
                  uniqueEmailForNewIssuer === true) ||
                (activeStep === 2 &&
                  typeOfCertificate === "caissued" &&
                  subjectTypeSelected === "new" &&
                  uniqueEmailForNewSubject === true) ||
                (activeStep === 2 &&
                  typeOfCertificate === "caissued" &&
                  subjectTypeSelected === "existing" &&
                  selectedSubjectEmail == null) ||
