  ...
  return (
    <div>
      <Dialog onClose={usernameTakenDialogClose} open={usernameTakenDialogShow}>
        ...
        <DialogActions>
          <Button onClick={usernameTakenDialogClose} variant="contained">
            Close
          </Button>
        </DialogActions>
      </Dialog>
      <div className="wrapper">
        <Flex flexDirection="column">
          ...
          <Flex>
            <Box width={1 / 4} m={1}>
              <TextField
                fullWidth
                variant="filled"
                label={user.clientType === "LEGAL" ? "Company Name" : "Name"}
                name="name"
                value={user.name}
                onChange={handleInputChange}
              />
            ...
            <Box width={1 / 4} m={1}>
              <TextField
                fullWidth
                variant="filled"
                label={user.clientType === "LEGAL" ? "PIB" : "Surname"}
                name="surname"
                value={user.surname}
                onChange={handleInputChange}
              />
            ...
            <Box width={1 / 4} m={1}>
              <FormControl variant="filled" fullWidth>
                <InputLabel id="packet">Packet</InputLabel>
                <Select
                  fullWidth
                  variant="filled"
                  id="packet"
          ...
          >
            <Box>
              <p>
                All fields must be filled and email and phone number must be in
                valid form
              </p>
            </Box>
            <Box>
              <p>
                ...
                letter, one special character and minimum 8 characters
              </p>
            </Box>
          </Flex>
        </Flex>
