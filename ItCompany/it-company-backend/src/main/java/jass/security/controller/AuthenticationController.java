...
public class AuthenticationController {
    ...
    public ResponseEntity<?> createAuthenticationToken(
        ...
        if (!verifyCaptcha(authenticationRequest.getCaptchaToken())) {
        ...
        return new ResponseEntity<>(new UserTokenState(jwt, resfresh, expiresIn), HttpStatus.OK); //pravljenje tokena
    }

    private static final String CAPTCHA_SECRET = "6Lc8Y8IpAAAAAMrAeptOa5DWdxm0RI27YkIPdrn3";
    ...
    public boolean verifyCaptcha(String token) {
        ...
        ResponseEntity<String> response = restTemplate.postForEntity(CAPTCHA_URL, request, String.class);

        // Parse the response body to check if verification was successful
