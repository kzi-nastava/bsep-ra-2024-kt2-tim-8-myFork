...
public interface IAccountService extends ICrudService<Account> {
    ...
    void registerAccount(RegisterAccountDto dto) throws EmailTakenException, NotFoundException, EmailRejectedException, IOException;

    UUID registerAdminAccount(RegisterAdminAccountDto dto) throws EmailTakenException, IOException;
    ...
    byte[] getTwoFactorAuthQr(String email) throws IOException;
}
