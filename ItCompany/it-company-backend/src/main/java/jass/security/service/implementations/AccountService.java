...
public class AccountService implements IAccountService {
    ...
    public void registerAccount(RegisterAccountDto dto) throws EmailTakenException, NotFoundException, EmailRejectedException, IOException {
        ...
        addressRepository.save(address);
            ...
            employee.setClientType(dto.getClientType());
            employee.setPacket(dto.getPacket());
            role = _roleRespository.findByName("ROLE_CLIENT");
    ...
    @Override
    @Transactional(rollbackFor = {Exception.class})
    public UUID registerAdminAccount(RegisterAdminAccountDto dto) throws EmailTakenException, IOException {
        Address address = makeAddress(dto.getAddress());
        UUID adminId = UUID.randomUUID();

        Administrator admin = new Administrator(adminId, dto.getName(), dto.getSurname(), address, dto.getPhoneNumber());
    ...
    private Account makeAdminAccount(RegisterAdminAccountDto dto, UUID adminId) throws EmailTakenException, IOException {
        try {
            findByEmail(dto.getEmail());
            throw new EmailTakenException();
        } catch (NotFoundException ignored) {
    ...
    @Override
    public byte[] getTwoFactorAuthQr(String email) throws IOException {
